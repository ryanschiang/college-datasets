...
export const cdsSchema = z.object({
  ...
  //     number_of_ftfy_students_applied_for_aid: z.number().optional().describe("H2: Row A: Number of students in line a who applied for need-based financial aid | Col: First-time Full-Time First-year Students"),
  //     number_of_full_time_undergraduate_students_applied_for_aid: z.number().optional().describe("H2: Row A: Number of students in line a who applied for need-based financial aid | Col: Full-time Undergrad (Incl. First-Year)"),
  //     number_of_part_time_undergraduate_students_applied_for_aid: z.number().optional().describe("H2: Row A: Number of students in line a who applied for need-based financial aid | Col: Less Than Full-time Undergrad"),
  //     number_of_ftfy_students_with_financial_need: z.number().optional().describe("H2: Row A: Number of students in line b who were determined to have financial need | Col: First-time Full-Time First-year Students"),
  //     number_of_full_time_undergraduate_students_with_financial_need: z.number().optional().describe("H2: Row A: Number of students in line b who were determined to have financial need | Col: Full-time Undergrad (Incl. First-Year)"),
  //     number_of_part_time_undergraduate_students_with_financial_need: z.number().optional().describe("H2: Row A: Number of students in line b who were determined to have financial need | Col: Less Than Full-time Undergrad"),
  //   })
  //   .describe("H2: Number of Enrolled Students Awarded Aid"),
  // // H2A
  // number_of_enrolled_students_awarded_non_need_based_aid: z.object({}).describe("H2A: Number of Enrolled Students Awarded Non-need-based Scholarships and Grants"),
});
